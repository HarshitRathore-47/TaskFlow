...
const InviteMemberDialog = ({ isDialogOpen, setIsDialogOpen }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/20 dark:bg-black/50 backdrop-blur flex items-center justify-center z-50">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg p-6 w-full max-w-md text-zinc-900 dark:text-zinc-200 shadow-xl">
        {/* Header */}
        <div className="mb-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={isSubmitting || !currentWorkspace || !isAdmin}
                className="px-5 py-2 rounded text-sm bg-gradient-to-br from-blue-500 to-blue-600 text-white disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90 transition shadow-lg shadow-blue-500/20"
              >

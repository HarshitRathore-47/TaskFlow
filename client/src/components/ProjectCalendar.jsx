  ...
  return (
    <div className="grid lg:grid-cols-3 gap-6">
      ...
      <div className="lg:col-span-2 ">
        <div className="bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg p-4 shadow-sm">
        ...
        {getTasksForDate(selectedDate).length > 0 && (
          <div className="bg-white mt-6 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg p-4 shadow-sm">

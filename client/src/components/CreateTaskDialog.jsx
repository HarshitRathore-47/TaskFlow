...
export default function CreateTaskDialog({
  ...
  console.log("Workspace Members for Task:", workspaceMembers);
  ...
  return showCreateTask ? (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 dark:bg-black/60 backdrop-blur">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-lg shadow-xl w-full max-w-md p-6 text-zinc-900 dark:text-white">

        ...
        <div className="absolute z-50 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded shadow-lg top-full left-0">
          <div className="p-2">
            ...
            {workspaces.map((ws) => (
              ...
              >
                <div className="w-6 h-6 rounded bg-blue-400 flex items-center justify-center text-white text-xs font-bold">
                  {ws.name.charAt(0)}
                </div>
            ...
            <button
              ...
              className="w-full flex items-center gap-2 p-2 mt-2 text-sm text-blue-600 dark:text-blue-400 font-medium hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded transition"
            >
              <Plus size={16} />
              Create Workspace
            </button>

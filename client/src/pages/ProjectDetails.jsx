    ...
    <div className="space-y-5 max-w-6xl mx-auto text-zinc-900 dark:text-white">
      ...
      <div className="grid grid-cols-2 sm:flex flex-wrap gap-6">
        {[
          ...
          {
            label: "Team Members",
            value: project?.workspace?.members?.length || 0,
            color: "text-blue-700 dark:text-blue-400",
          },
        ].map((card, idx) => (
          <div
            key={idx}
            className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex justify-between sm:min-w-60 p-4 py-2.5 rounded-lg shadow-sm"
          >
            <div>
